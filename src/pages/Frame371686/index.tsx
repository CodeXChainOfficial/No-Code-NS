...
const Frame371686Page: React.FC = () => {
  const nameServiceDefineFunctionalityRadiobuttonPropList = [
    ...
    {
      tokenholderstext: "Identity and Branding",
      toactasvotingtext:
  ...
  const nameServiceDefineFunctionalityRadiobuttonPropList1 = [
    {
      contrastimage: "images/img_contrast.svg",
      tokenholderstext: "Primary Color",
      toactasvotingtext: "FFFFF",
    },
    {
      contrastimage: "images/img_contrast_gray_200.svg",
      tokenholderstext: "Secondary Color",
      toactasvotingtext: "000000",
    },
    {
      contrastimage: "images/img_globe.svg",
      tokenholderstext: "Text Color 1",
      toactasvotingtext: "40CD81",
    },
    {
      contrastimage: "images/img_contrast_blue_gray_100.svg",
      tokenholderstext: "Text Color 2",
  ...
  return (
    <>
      <div className="flex flex-col font-raleway items-center justify-start mx-auto w-full">
        <div className="bg-black-900 flex h-[2608px] justify-end md:px-5 relative w-full">
          <NameServiceDefineFunctionalityProcesdao className="absolute bg-black-900 flex flex-col inset-x-[0] items-center justify-start max-w-[1440px] mx-auto pt-8 md:px-10 px-20 sm:px-5 top-[7%] w-full" />
          <Text
            className="absolute capitalize left-[6%] text-5xl sm:text-[38px] md:text-[44px] text-white-A700 top-[3%] tracking-[2.40px]"
            size="txtRalewayRomanSemiBold48"
          >
            Name Service
          </Text>
          <div className="flex flex-col h-full items-start justify-start mb-[82px] mt-auto mx-auto w-[92%]">
                    ...
                    <div className="flex flex-col gap-[3px] items-center justify-start w-full">
                      <div className="bg-black-900_01 border border-solid border-white-A700_19 flex flex-col gap-2 items-start justify-start px-4 py-8 rounded-lg w-full">
                        ...
                        <div className="border-solid border-white-A700_19 border-y flex md:flex-col flex-row md:gap-10 items-center justify-between py-4 w-full">
                          <div className="border border-solid border-white-A700_19 flex flex-col h-[41px] md:h-auto items-start justify-start sm:px-5 px-8 py-4 w-[330px]">
                          ...
                          <div className="bg-white-A700_33 flex flex-col font-inter items-start justify-start sm:px-5 px-8 py-4 rounded-lg w-auto">
                            <Text
                              className="capitalize text-base text-white-A700_e5 tracking-[0.80px] w-auto"
                              size="txtInterSemiBold16"
                            >
            ...
            <div className="flex flex-row gap-8 items-start justify-start md:ml-[0] ml-[1145px] mt-[95px] w-auto">
          ...
          <div className="absolute bg-black-900_0c flex flex-col h-full inset-[0] items-center justify-center m-auto p-[442px] md:px-10 sm:px-5 w-full">
            <Img
              className="h-[599px] md:h-auto mb-[663px] mt-[462px] object-cover w-full"
              src="images/img_screenshot20230825.png"
              alt="screenshot20230"
            />
          </div>
        </div>
...
export default Frame371686Page;
